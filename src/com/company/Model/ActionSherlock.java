...
public class ActionSherlock extends Action{
    private String nomFace;

    public ActionSherlock(String nomFace) {
    ...
    public void makeActionSherlock(Detective detective, Tile[][] plateau, int nbEspace){
